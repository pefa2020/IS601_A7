...
def test_calculator_add(page, fastapi_server):
    ...
    # Wait for the result to appear in the DOM before checking it.
    # This ensures the async JavaScript has completed and updated the result div.
    page.locator('#result:has-text("Result: 15")').wait_for()
...
def test_calculator_divide_by_zero(page, fastapi_server):
    ...
    # Wait for the error message to appear in the DOM before checking it.
    # This ensures the async JavaScript has completed and updated the result div.
    page.locator('#result:has-text("Error: Cannot divide by zero!")').wait_for()
